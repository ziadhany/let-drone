        ...
        <>
            <div className="h-screen w-screen bg-gray-100 pt-10 ">
                <div className="max-w-3xl mx-auto bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    </section><section id="how-it-works" className="container mx-auto py-16 px-4 text-center">
                    <h2 className="text-3xl font-bold text-gray-800 mb-8">How It Works</h2>
                    <p className="text-lg text-gray-600">
                        "Let-Drone" leverages smart contracts and blockchain technology to provide a transparent and secure experience in tracking drone in emergency situations.
                    </p>
                </section>
